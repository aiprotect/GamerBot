...
class Methods:
    ...
    def createChatVoiceChat(self, objectGuid:str) -> dict:
        ...
        return self.network.request(
            ...
            input={"chat_guid": objectGuid}

            # method=f"create'{chatType}Voice'Chat",
            # input={f"{chatType.lower()}_guid": objectGuid}
        )
    ### SET ALL 'GroupVoice' instead -> '{chatType}Voice'
    ...
    def sendChatVoiceChatActivity(self, objectGuid:str, voideChatId:str, activity:str, participantObjectGuid:str) -> dict:
        ...
        return self.network.request(
            method="sendGroupVoiceChatActivity",
            input={
                "chat_guid": objectGuid,
                "voice_chat_id": voideChatId,
                "activity": activity,
    ...
    async def playVoice(self, objectGuid:str, file: str, voiceChatId = False) -> None:
        try:
