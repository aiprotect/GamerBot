...
class Client(object):
    ...
    def join_voice_chat(self, object_guid:str, my_guid:str, voice_chat_id:str,sdp_offer_data:str='') -> dict:
        return self.methods.joinVoiceChat(objectGuid=object_guid, myGuid=my_guid, voiceChatId=voice_chat_id, sdp_offer_data=sdp_offer_data)
    ...
    def play_voice(self, object_guid: str, file:str, voice_chat_id = False) -> None:
        from asyncio import run
        
        async def main():
            await self.methods.playVoice(objectGuid=object_guid, file=file, voiceChatId=voice_chat_id)
